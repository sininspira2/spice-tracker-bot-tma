        ...
        "sections": [
            {
                ...
                "commands": [
                    ...
                    {
                        "name": "/calc [amount]",
                        "desc": "Estimate melange from sand without saving.",
                    },
                ],
            }
        ],
        ...
        "sections": [
            {
                ...
                "commands": [
                    {
                        "name": "/sand [amount]",
                        "desc": "Convert your sand into melange.",
                    },
                    {
                        "name": "/refinery",
                        "desc": "View your melange production and payment status.",
                    },
                    {
                        "name": "/ledger",
                        "desc": "View your personal conversion history.",
                    },
                    {
                        "name": "/leaderboard [limit]",
                        "desc": "See the top melange producers.",
                    },
                    {
                        "name": "/split [sand] [users]",
                        "desc": "Split sand with others and convert it to melange.",
                    },
                    {
                        "name": "/expedition [id]",
                        "desc": "View the details of a specific split/expedition.",
                    },
                    {
                        "name": "/water [destination]",
                        "desc": "Request a water delivery.",
                    },
                ],
            }
        ],
        ...
        "sections": [
            {
                ...
                "commands": [
                    {
                        "name": "/pending",
                        "desc": "View all users with pending (unpaid) melange.",
                    },
                    {
                        "name": "/pay [user] [amount]",
                        "desc": "Pay a user their pending melange.",
                    },
                    {
                        "name": "/payroll [confirm]",
                        "desc": "Pay all users with pending melange at once.",
                    },
                ],
            },
            {
                ...
                "commands": [
                    {
                        "name": "/guild treasury",
                        "desc": "View the guild's treasury balance.",
                    },
                    {
                        "name": "/guild withdraw [user] [amount]",
                        "desc": "Withdraw melange from the treasury to a user.",
                    },
                    {
                        "name": "/guild transactions",
                        "desc": "View the guild's transaction history.",
                    },
                    {
                        "name": "/guild payouts",
                        "desc": "View the guild's melange payout history.",
                    },
                ],
            },
        ],
        ...
        "sections": [
            {
                ...
                "commands": [
                    {
                        "name": "/settings [subcommand]",
                        "desc": "View a setting by calling it without options.",
                    },
                    {
                        "name": "/settings <admin_roles|officer_roles|user_roles> [roles]",
                        "desc": "Set or clear permission roles.",
                    },
                    {
                        "name": "/settings landsraad [action]",
                        "desc": "Manage the Landsraad conversion bonus.",
                    },
                    {
                        "name": "/settings <user_cut|guild_cut> [value]",
                        "desc": "Set default percentages for `/split`.",
                    },
                    {
                        "name": "/settings region [region]",
                        "desc": "Set the guild's primary operational region.",
                    },
                ],
            },
            {
                ...
                "commands": [
                    {
                        "name": "/reset [confirm]",
                        "desc": "Reset all data (Admin Only).",
                    },
                    {
                        "name": "/sync",
                        "desc": "Sync commands with Discord (Bot Owner Only).",
                    },
                ],
            },
        ],
...
def build_help_pages(interaction: discord.Interaction) -> list[discord.Embed]:
    ...
    for i, page_content in enumerate(PAGES_CONTENT):
        ...
        embed.set_footer(
            text=f"Page {i + 1}/{total_pages} • Use the buttons to navigate."
        )

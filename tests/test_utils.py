...
class TestHelpers:
    ...
    async def test_send_response_interaction(self, mock_interaction):
        ...
        await send_response(
            mock_interaction, content="Test message", use_followup=False
        )
    ...
    async def test_send_response_followup(self, mock_interaction):
        ...
        await send_response(
            mock_interaction, content="Test message", use_followup=True, ephemeral=True
        )

        mock_interaction.followup.send.assert_called_once_with(
            content="Test message", ephemeral=True
        )

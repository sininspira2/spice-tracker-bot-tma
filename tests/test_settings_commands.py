...
def mock_get_db(mocker, test_database):
    mocker.patch(
        "commands.settings.get_database", return_value=test_database, create=True
    )
...
class TestSettingsCommand:
    ...
    @pytest.mark.parametrize(
        "role_type, command_name, get_func, permission_level",
        [
    ...
    async def test_settings_role_commands(
        self, mock_interaction, role_type, command_name, get_func, permission_level
    ):
        ...
        with patch("commands.settings.check_permission") as mock_check_permission:
            ...
            await command.callback(
                settings_command_group, mock_interaction, roles="123"
            )
            ...
            await command.callback(
                settings_command_group, mock_interaction, roles="12345, 67890"
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            ...
            await command.callback(
                settings_command_group, mock_interaction, roles="<@&98765> <@&43210>"
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            ...
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            assert (
                "Currently configured roles: <@&11111>, <@&22222>" in embed.description
            )
            mock_interaction.reset_mock()
    ...
    async def test_settings_user_cut(self, mock_interaction):
        ...
        with patch("commands.settings.check_permission", return_value=True):
            ...
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.user_cut.callback(
                settings_command_group, mock_interaction, value=None
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            ...
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.user_cut.callback(
                settings_command_group, mock_interaction, value=15
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            ...
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.user_cut.callback(
                settings_command_group, mock_interaction, value=0
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
    ...
    async def test_settings_guild_cut(self, mock_interaction):
        ...
        with patch("commands.settings.check_permission", return_value=True):
            ...
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.guild_cut.callback(
                settings_command_group, mock_interaction, value=None
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            ...
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.guild_cut.callback(
                settings_command_group, mock_interaction, value=25
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
    ...
    async def test_settings_region(self, mock_interaction):
        ...
        with patch("commands.settings.check_permission", return_value=True):
            update_region(None)
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.region.callback(
                settings_command_group, mock_interaction, region=None
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
            ...
            mock_interaction.response.is_done = Mock(return_value=True)
            await settings_command_group.region.callback(
                settings_command_group, mock_interaction, region=mock_choice
            )
            embed = mock_interaction.followup.send.call_args.kwargs["embed"]
